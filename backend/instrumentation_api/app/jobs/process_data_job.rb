EVENT_PROCESSOR_KLASS_DICT = {
  page: EventProcessors::PageView,
  identify: EventProcessors::Identify,
}
...
class ProcessDataJob
  ...
  def perform(api_key, data)
    ...
    data.each do |raw_event|
      processor_klass = EVENT_PROCESSOR_KLASS_DICT.with_indifferent_access[raw_event['type']] || EventProcessors::Custom
      begin
