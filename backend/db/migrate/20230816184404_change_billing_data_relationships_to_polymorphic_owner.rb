class ChangeBillingDataRelationshipsToPolymorphicOwner < ActiveRecord::Migration[6.1]
  def up
    add_reference :analytics_customer_billing_data_snapshots, :owner, polymorphic: true, index: true, type: :uuid
    add_reference :analytics_customer_subscriptions, :owner, polymorphic: true, index: true, type: :uuid
    rename_table :analytics_payments, :analytics_customer_payments
    add_reference :analytics_customer_payments, :owner, polymorphic: true, index: true, type: :uuid
  end
