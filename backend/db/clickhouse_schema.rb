...
ClickhouseActiverecord::Schema.define(version: 2023_11_14_202338) do
...
#   Unknown type 'Enum8('user' = 1, 'organization' = 2)' for column 'swishjam_owner_type'
  ...
  # TABLE: user_organization_device_identifiers
  # SQL: CREATE TABLE swishjam_analytics_test.user_organization_device_identifiers ( `swishjam_api_key` String, `organization_device_identifier` String, `user_device_identifier` String, `created_at` DateTime ) ENGINE = ReplacingMergeTree PRIMARY KEY (swishjam_api_key, organization_device_identifier, user_device_identifier) ORDER BY (swishjam_api_key, organization_device_identifier, user_device_identifier) SETTINGS index_granularity = 8192
  create_table "user_organization_device_identifiers", id: false, options: "ReplacingMergeTree PRIMARY KEY (swishjam_api_key, organization_device_identifier, user_device_identifier) ORDER BY (swishjam_api_key, organization_device_identifier, user_device_identifier) SETTINGS index_granularity = 8192", force: :cascade do |t|
    t.string "swishjam_api_key", null: false
    t.string "organization_device_identifier", null: false
    t.string "user_device_identifier", null: false
    t.datetime "created_at", null: false
  end
