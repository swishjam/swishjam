module Analytics
  class Organization < ApplicationRecord
    ...
    has_many :billing_data_snapshots, class_name: Analytics::CustomerBillingDataSnapshot.to_s, as: :owner, dependent: :destroy
    has_many :payments, class_name: Analytics::CustomerPayment.to_s, as: :owner, dependent: :destroy
    has_many :subscriptions, class_name: Analytics::CustomerSubscription.to_s, as: :owner, dependent: :destroy
