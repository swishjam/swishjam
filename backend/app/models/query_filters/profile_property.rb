# TODO: this is now deprecated in favor of ProfileProperty
# we can destroy this basically as soon as we deploy/migrate
module QueryFilters
  class ProfileProperty < QueryFilter
    self.required_config_keys = %i[property_name operator profile_type]
