module Swishjam
  class Organization < ApplicationRecord
    ...
    has_many :analytics_organizations, class_name: Analytics::Organization.to_s, foreign_key: :swishjam_organization_id, dependent: :destroy
    has_many :analytics_users, class_name: Analytics::User.to_s, foreign_key: :swishjam_organization_id, dependent: :destroy
    has_many :analytics_devices, class_name: Analytics::Device.to_s, foreign_key: :swishjam_organization_id, dependent: :destroy
    has_many :analytics_sessions, through: :devices, class_name: Analytics::Session.to_s, foreign_key: :swishjam_organization_id, dependent: :destroy
