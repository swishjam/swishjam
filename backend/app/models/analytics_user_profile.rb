class AnalyticsUserProfile < Transactional
  ...
  has_many :analytics_organization_profile_users, foreign_key: :analytics_user_profile_unique_identifier, primary_key: :user_unique_identifier, dependent: :destroy
