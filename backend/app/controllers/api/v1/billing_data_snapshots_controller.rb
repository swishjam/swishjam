    ...
    class BillingDataSnapshotsController < BaseController
      def index
        ...
        if !public_keys_for_requested_data_source || public_keys_for_requested_data_source.empty?
          # a crappy hack to generate the correctly formatted data for the time being
          render json: {
            current_mrr: 0,
            comparison_mrr: 0,
            change_in_mrr: 0,
            current_mrr_timeseries: [],
            comparison_mrr_timeseries: [],
            current_total_revenue: 0,
            comparison_total_revenue: 0,
            change_in_total_revenue: 0,
            current_total_revenue_timeseries: [],
            comparison_total_revenue_timeseries: [],
            current_num_active_subscriptions: 0,
            comparison_num_active_subscriptions: 0,
            change_in_num_active_subscriptions: 0,
            current_num_active_subscriptions_timeseries: [],
            comparison_num_active_subscriptions_timeseries: [],
            current_num_free_trial_subscriptions: 0,
            comparison_num_free_trial_subscriptions: 0,
            change_in_num_free_trial_subscriptions: 0,
            current_num_free_trial_subscriptions_timeseries: [],
            comparison_num_free_trial_subscriptions_timeseries: [],
            current_num_canceled_subscriptions: 0,
            comparison_num_canceled_subscriptions: 0,
            change_in_num_canceled_subscriptions: 0,
            current_num_canceled_subscriptions_timeseries: [],
            comparison_num_canceled_subscriptions_timeseries: [],
