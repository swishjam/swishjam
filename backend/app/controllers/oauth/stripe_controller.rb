  ...
  class StripeController < ApplicationController
    def callback
      if params[:error] || !params[:code] || !params[:state]
        redirect_to "#{ENV['FRONTEND_URL'] || 'https://app.swishjam.com'}/connections?success=false&message=#{params[:error_description]}"
        return
      end
      ...
      redirect_to "#{ENV['FRONTEND_URL'] || 'https://app.swishjam.com'}/connections?success=true"
    end
