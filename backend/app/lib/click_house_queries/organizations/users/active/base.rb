    ...
    module Users
      module Active
        class Base
          ...
          def initialize(public_key, organization_profile_id:, analytics_family: 'product', start_time: self.class.default_start_time, end_time: self.class.default_end_time || Time.current)
