      ...
      def sql
        <<~SQL
          SELECT 
            ...
            JSONExtractString(e.properties, 'device_identifier') AS device_identifier,
          ...
          JOIN (
            ...
            FROM user_identify_events uie
            GROUP BY uie.device_identifier
          ) AS latest_identify_per_device ON JSONExtractString(e.properties, 'device_identifier') = latest_identify_per_device.device_identifier
