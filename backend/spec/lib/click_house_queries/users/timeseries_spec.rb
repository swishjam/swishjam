...
describe ClickHouseQueries::Users::Timeseries do
  ...
  describe '#get' do
    it 'works' do
      ...
      FactoryBot.create(:user_segment_filter, user_segment: segment, sequence_index: 1, config: { 'object_type' => 'event', 'event_name' => 'test', 'num_lookback_days' => 30, 'num_event_occurrences' => 2 })
