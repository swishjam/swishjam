...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.addIndex('measure_performance_entries', ['uuid']);
    await queryInterface.addIndex('measure_performance_entries', ['page_view_uuid']);
    await queryInterface.addIndex('measure_performance_entries', ['project_key']);
  },
