...
export default async (req, res) => {
  ...
  const { organizationId, projectKey, urlHost, urlPath, startTs = defaultTs } = req.query;

  await Validator.runQueryIfUserHasAccess({ req, res, organizationId, projectKey }, async () => {
    try {
