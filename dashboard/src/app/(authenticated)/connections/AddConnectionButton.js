...
export default function AddConnectionButton({ img, connection, onConnectionClick }) {
  ...
  return (
    <div 
      className="rounded-xl border border-gray-200 bg-white group cursor-pointer hover:bg-gray-50 duration-300 transition hover:ring-2 offset-2 ring-swishjam"
