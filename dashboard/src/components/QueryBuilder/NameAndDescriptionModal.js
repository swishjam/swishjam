...
export default function NameAndDescriptionModal({ defaultName = '', defaultDescription = '', isOpen, onClose, onSave, saveText = 'Create Segment' }) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title='Name your segment'>
      <form onSubmit={e => {
        e.preventDefault()
