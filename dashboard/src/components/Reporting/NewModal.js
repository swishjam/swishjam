                ...
                {showSuccessMessage
                  ? (
                    <div className='text-center'>
                      ...
                      <h3 className="text-lg text-gray-900 text-center mt-3">{successMessage || 'Report added'}</h3>
                      <button
                    ...
                    <form onSubmit={submitConfiguration}>
                      ...
                      <div className="sm:flex sm:flex-row-reverse mt-6">
                        <button
                          ...
                          disabled={loading}
                        >
                          {loading ? <div className={'mx-8'} ><LoadingSpinner color="white" /></div> : 'Add Report'}
                        </button>
                      </div>
                    </form>
                  )}
