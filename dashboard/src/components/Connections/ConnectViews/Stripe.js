...
export default function StripeConnectionView() {
  ...
  return (
    <a
      ...
      href={`https://connect.stripe.com/oauth/authorize?response_type=code&client_id=ca_ONSwwqiCfDZHQzg1hURYH5pfTVj1PrAe&scope=read_write&redirect_uri=http://localhost:4242/oauth/stripe/callback&state={"authToken":"${token}"}`}
    >
      Connect Stripe
    </a>
  )
