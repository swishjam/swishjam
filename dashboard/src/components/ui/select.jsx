...
const SelectTrigger = React.forwardRef(({ className, children, noRing = false, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      noRing && "ring-0 focus:ring-0 focus-visible:ring-0 focus:outline-none focus:border-zinc-200",
      className
    )}
    {...props}>
    {children}
