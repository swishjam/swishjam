...
export default function AddIntegrationButton({ img, integration, onIntegrationClick, borderImage = false }) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-x-4 py-4">
        ...
        />
        <div className="text-sm font-medium leading-6 text-gray-900">{integration.name}</div>
